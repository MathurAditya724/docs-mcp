  ...
  "features": [
    {
      ...
      "description": "Automatically capture errors and exceptions from Django views, middleware, and signals.",
    ...
    },
    {
      ...
      "description": "Monitor performance of Django middleware, signals, database queries, Redis commands, and cache operations.",
      "name": "Tracing",
      "setup": "Set traces_sample_rate in your sentry_sdk.init() call to enable performance monitoring. You can optionally pass DjangoIntegration explicitly to configure tracing options such as middleware_spans, signals_spans, and cache_spans. The integration automatically monitors the middleware stack, signals, database queries, Redis commands, and Django cache access.",
      "slug": "tracing"
    },
    {
      "code": "import sentry_sdk\n\nsentry_sdk.init(\n    dsn=\"___PUBLIC_DSN___\",\n    send_default_pii=True,\n    traces_sample_rate=1.0,\n    profile_session_sample_rate=1.0,\n    profile_lifecycle=\"trace\",\n)",
      "description": "Collect code-level profiling data for Django requests to identify performance bottlenecks.",
      "name": "Profiling",
      "setup": "Set profile_session_sample_rate and profile_lifecycle in your sentry_sdk.init() call along with traces_sample_rate. Profiles are automatically collected while there is an active span, giving you code-level visibility into your Django application's performance.",
      "slug": "profiling"
    },
    {
